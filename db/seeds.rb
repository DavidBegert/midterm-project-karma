...
ju = User.create!(username: "JulianaHosoume", password: "julanapass", email: "juliana@juliana.com", image_url: "http://blogdailyherald.com/wp-content/uploads/2014/10/wallpaper-for-facebook-profile-photo.jpg")
...
ju_deed_1 = ju.deeds.create!(summary: "I helped some people study")
